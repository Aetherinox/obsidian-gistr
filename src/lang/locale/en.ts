...
export default
{
    ...
    */
    ...
    cfg_tab_su_build_id_cur_name:               'Build id',
    cfg_tab_su_build_id_cur_desc:               'Build id for your current running release of Gistr',
    cfg_tab_su_build_id_btn_tip:                'Copy to clipboard',
    cfg_tab_su_build_id_notice:                 'Copied Gistr build id to clipboard\n\n{0}',
